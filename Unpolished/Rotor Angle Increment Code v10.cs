...
/*
// Whip's Rotor Controller v10 /// revision: 1/5/2019 
...
const float ROTATION_SPEED_GAIN = 15;
    ...
    if (isNumeric)
    {
        if (setRotorAngle) //set rotor angle
        {
            ...
            foreach (var block in rotors)
            {
                ...
                {
                    var activeRotor = new RotorController(block, thisValue, false, ROTATION_SPEED_GAIN);
