...
/* 
///Whip's Raycast Rangefinder v10 - 7/7/17///
///HOWDY!///
...
2.) Place a timer on your ship
    - Make it "Start" itself
    - Make it "Trigger Now" itself
    - Make it "Run with default argument" this program block
    
3.) Place at least one camera on your ship with the name tag "Raycast" 
    in the name somewhere
    
4.) Place at least one LCD or text panel on your ship with the name tag
    "Raycast" somewhere in the name
    
5.) Run the code with the argument "start" to start scanning!
